<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <div class="ribbon"><a href="<?php echo home_url( '/' ); ?>type/video/"><div class="shadow"></div></a></div>
 ...
 <section class="entry-content">
  <div class="entry-inner clearfix">
   <?php exultic_embed_video($post->ID);
   exultic_video($post->ID);
  exultic_entry_content($post->ID); ?>  </div>
 </section>
